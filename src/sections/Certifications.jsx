...
const badgeMap = { cyan: "badge-cyan", indigo: "badge-indigo", green: "badge-green" };
          ...
          {certifications.map((cert, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                ...
                {cert.badge && <span className={`badge ${badgeMap[cert.badgeColor] || "badge-amber"}`}>{cert.badge}</span>}
              </div>
